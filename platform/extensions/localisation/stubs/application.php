...
return array(
     ...
     *
     */
    'key' => '{{app_key}}', # this should always use the generated one !
    ...
    # criar um if quando se for a alterar este valor.
    # pois o utilizador pode não pretender usar locale slugs.
